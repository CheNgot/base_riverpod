    ...
    return _then(_value.copyWith(
      ...
      password_confirmation: password_confirmation == freezed
          ...
          : password_confirmation // ignore: cast_nullable_to_non_nullable
              as String?,
      current_password: current_password == freezed
...
class _$_RequestChangePassword implements _RequestChangePassword {
  ...
  @override
  String toString() {
    return 'RequestChangePassword(password: $password, password_confirmation: $password_confirmation, current_password: $current_password)';
  }
    ...
    return identical(this, other) ||
        (other is _RequestChangePassword &&
            ...
            (identical(other.current_password, current_password) ||
                const DeepCollectionEquality()
                    .equals(other.current_password, current_password)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(current_password);
...
abstract class _RequestChangePassword implements RequestChangePassword {
  factory _RequestChangePassword(
      {String? password,
      String? password_confirmation,
      String? current_password}) = _$_RequestChangePassword;
