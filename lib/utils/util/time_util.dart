...
const String DATE_FORMAT_10 = "MM-yyyy";
const String DATE_FORMAT_11 = "HH:mm:ss";
...
String getDefaultFormatTime(String? rawTime) {
  String time = "";
  try {
    time = DateFormat(DATE_FORMAT_1).format(DateTime.parse(rawTime ?? ""));
  } catch (e) {}
  return time;
}
