...
import 'list_view_load_more.dart';
...
class GridViewLoadMore<T> extends StatefulWidget {
  ...
  @override
  GridViewLoadMoreState<T> createState() => GridViewLoadMoreState<T>();
}

class GridViewLoadMoreState<T> extends State<GridViewLoadMore<T>> {
              ...
              child: SingleChildScrollView(
                ...
                child: LiveGrid.options(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    crossAxisSpacing: widget.crossAxisSpacing ?? 20,
  ...
  void _scrollListener() async {
    // print((controller?.position.extentAfter ?? 0));
