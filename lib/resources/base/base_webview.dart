...
mixin BaseWebView<T extends StatefulWidget> on State<T> {
  ...
  Widget buildWebView({String? htmlStr, String? linkUrl}) {
    return Stack(
      children: [
        InAppWebView(
          ...
          <html>
            ...
            <body style='"margin: 0; padding: 0;'>
              ...
              String htmlStrWithFont =
                  await _addFontToHtml(newHtml, "assets/fonts/Roboto-Regular.ttf", "font/opentype");
        ...
        isShowLoading == true ? LoadingWave() : SizedBox(),
      ],
    );
  }
  ...
  Future<String> _addFontToHtml(String htmlContent, String fontAssetPath, String fontMime) async {
    final fontData = await rootBundle.load(fontAssetPath);
    final fontUri = _getFontUri(fontData, fontMime).toString();
    final fontCss =
        '@font-face { font-size: ${18.sp}px; font-family: customFont; src: url($fontUri); } * { font-size: ${18.sp}px; font-family: customFont; }';
