...
final storeViewModel = ChangeNotifierProvider.autoDispose((ref) =>
    StoreViewModel(ref.read(orderRepositoryProvider), ref.read(hiveProvider),
        ref.read(broadCastProvider), ref.read(commonRepositoryProvider)));

class StoreViewModel extends BaseLoadingChangeNotifier {
  final HiveProvider _hiveProvider;
  final AppBroadCast _broadCastProvider;
  final CommonRepository _commonRepository;
  final OrderRepository _orderRepository;

  StoreViewModel(this._orderRepository, this._hiveProvider,
