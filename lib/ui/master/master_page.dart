      ...
      child: Scaffold(
        ...
        body: Navigator(
          ...
          onGenerateRoute: (settings) {
            context
                .read(masterPageViewModel)
                .addPageToBackStack(settings.name, false);
            switch (settings.name) {
              ...
              case Constants.orderPage:
                return BasePageRoute(
                    settings: settings, builder: (context) => OrderPage());
              case Constants.storePage:
                return BasePageRoute(
                    settings: settings, builder: (context) => StorePage());
              case Constants.promotionPage:
                return BasePageRoute(
                    settings: settings, builder: (context) => PromotionPage());
              case Constants.otherPage:
                return BasePageRoute(
                    settings: settings, builder: (_) => OtherPage());
          ...
          children: <Widget>[
            ...
            Expanded(
                ...
                child: BottomBarButton(
                  ...
                  onPress: () {
                    _navigatorKey.currentState?.pushNamedAndRemoveUntil(
                        Constants.orderPage, (route) => route.isFirst,
                        arguments: false);
            ...
            Expanded(
              ...
              child: BottomBarButton(
                ...
                onPress: () {
                  _navigatorKey.currentState?.pushNamedAndRemoveUntil(
                      Constants.storePage, (route) => route.isFirst);
            ...
            Expanded(
              ...
              child: BottomBarButton(
                ...
                onPress: () {
                  _navigatorKey.currentState?.pushNamedAndRemoveUntil(
                      Constants.promotionPage, (route) => route.isFirst);
            ...
            Expanded(
              ...
              child: BottomBarButton(
                ...
                onPress: () {
                  _navigatorKey.currentState?.pushNamedAndRemoveUntil(
                      Constants.otherPage, (route) => route.isFirst);
