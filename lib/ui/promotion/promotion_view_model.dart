...
final promotionViewModel = ChangeNotifierProvider.autoDispose((ref) =>
    PromotionViewModel(ref.read(orderRepositoryProvider), ref.read(hiveProvider),
        ref.read(broadCastProvider), ref.read(commonRepositoryProvider)));

class PromotionViewModel extends BaseLoadingChangeNotifier {
  final HiveProvider _hiveProvider;
  final AppBroadCast _broadCastProvider;
  final CommonRepository _commonRepository;
  final OrderRepository _orderRepository;

  PromotionViewModel(this._orderRepository, this._hiveProvider,
