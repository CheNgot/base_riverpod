...
final accountViewModel = ChangeNotifierProvider.autoDispose((ref) =>
    AccountViewModel(ref.read(orderRepositoryProvider), ref.read(hiveProvider),
        ref.read(broadCastProvider), ref.read(commonRepositoryProvider)));

class AccountViewModel extends BaseLoadingChangeNotifier {
  final HiveProvider _hiveProvider;
  final AppBroadCast _broadCastProvider;
  final CommonRepository _commonRepository;
  final OrderRepository _orderRepository;

  AccountViewModel(this._orderRepository, this._hiveProvider,
