...
final orderHistoryViewModel = ChangeNotifierProvider.autoDispose((ref) =>
    OrderHistoryViewModel(ref.read(orderRepositoryProvider), ref.read(hiveProvider),
        ref.read(broadCastProvider), ref.read(commonRepositoryProvider)));

class OrderHistoryViewModel extends BaseLoadingChangeNotifier {
  final HiveProvider _hiveProvider;
  final AppBroadCast _broadCastProvider;
  final CommonRepository _commonRepository;
  final OrderRepository _orderRepository;

  OrderHistoryViewModel(this._orderRepository, this._hiveProvider,
